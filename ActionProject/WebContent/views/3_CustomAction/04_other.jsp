...
<body>
	...
	<%-- 		<c:param name="queryString" value="jstl"/> --%>
	<%-- 	</c:redirect> --%>
	...
	<jsp:setProperty property="name" name="p" value="홍길동"/><br>
	<jsp:setProperty property="age" name="p" value="30"/><br>
	<jsp:setProperty property="gender" name="p" value="남"/><br>
