 ...
 * Generated at: 2022-11-03 06:33:39 UTC
...
public final class thumbnailEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("				<td colspan=\"3\"><input type=\"text\" name=\"boardTitle\" required></td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<th>내용</th>\r\n");
      out.write("				<td colspan=\"3\">\r\n");
      out.write("					<textarea name=\"boardContent\" style=\"resize:none;\" rows=\"5\" required></textarea>\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<th>대표이미지</th><!-- 미리보기 -->\r\n");
      out.write("				<td colspan=\"3\" align=\"center\">\r\n");
      out.write("					<img id=\"titleImg\" width=\"250\" height=\"170\">\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<th>상세이미지</th><!-- 미리보기 -->\r\n");
      ...
      out.write("			<input type=\"file\" id=\"file1\" name=\"file1\" onchange=\"loadImg(this , 1);\" required><!-- 대표이미지 -->\r\n");
      ...
      out.write("			<!-- onchange : input태그의 내용물이 변경될시 발생하는 이벤트 -->\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<script>\r\n");
      out.write("			$(function(){\r\n");
      ...
      out.write("				// num : 몇번째 input 요소인지 확인후 해당 영역에 미리보기하기위한 하드코딩된 변수\r\n");
      out.write("				\r\n");
      out.write("				// console.log(inputFile.files , inputFile.files.length);\r\n");
      out.write("				/*\r\n");
      out.write("				   파일 선택시 length= 1 , 파일선택 취소시 length = 0 이 출력됨.=> 즉 파일의 존재유무를 알수있다.\r\n");
      out.write("				   files속성은 업로드된 파일의 정보들을 배열형식으로 여러개묶어서 반환, length는 그 배열의 크기.\r\n");
      out.write("				*/\r\n");
      out.write("				\r\n");
      out.write("				if(inputFile.files.length != 0){\r\n");
      out.write("					// 선택된 파일이 존재할 경우\r\n");
      out.write("					// 선택된 파일들을 읽어들여서 그 영역에 맞는곳에 미리보기\r\n");
      out.write("					\r\n");
      out.write("					// 파일을 읽어들일 FileReader 객체 생성\r\n");
      out.write("					let reader = new FileReader();\r\n");
      out.write("					\r\n");
      out.write("					// 파일을 읽어들이는 메소드 -> 어느파일을 읽어들일지 매개변수로 제시해야함.\r\n");
      out.write("					// 0번인덱스에 담긴 파일정보를 제시\r\n");
      out.write("					// => 해당파일을 읽어들이는 순간 해당 파일만의 고유한 url이 부여된다.\r\n");
      out.write("					// => 해당 url을 src의 속성값으로 제시.\r\n");
      out.write("					reader.readAsDataURL(inputFile.files[0]);\r\n");
      out.write("					\r\n");
      out.write("					// 파일 읽기가 완료되었을때 실행할 함수 정의\r\n");
      out.write("					reader.onload = function(e){ // e. target.result에 reader의 고유 url담김.\r\n");
      ...
      out.write("					\r\n");
      out.write("				}else{\r\n");
      out.write("					// 선택된 파일이 사라졌을경우 미리보기도 사라지게끔 작업.\r\n");
      out.write("					switch(num){\r\n");
